      ...
      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-ink/10 bg-white p-8 shadow-lg sm:p-10">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full rounded-full bg-gold px-6 py-3 text-sm font-semibold text-teal-deep transition-colors hover:bg-gold-bright focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2"
            >
              Masuk
            </button>
          </form>
