    ...
    <Section>
      ...
      <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
        <div className="rounded-3xl border border-ink/10 bg-white p-8 shadow-lg">
          <h2 className="text-lg font-semibold text-ink">Informasi Kontak</h2>
          <p className="mt-2 text-sm text-muted">Hubungi kami lewat email, WhatsApp, atau kirim pesan lewat formulir.</p>

          <div className="mt-6 space-y-4 text-sm">
            <div className="flex items-start gap-3">
              <div className="rounded-full bg-teal-deep/5 p-2 text-teal-deep">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href={`https://wa.me/62${SITE.phone.replace(/\D/g, "").replace(/^0/, "")}`} className="text-ink hover:underline">
                  {SITE.phone}
                </a>
              </div>
            </div>
              ...
              {SOCIAL_LINKS.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-teal-deep/5 px-3 py-1 text-sm text-teal-deep hover:bg-teal-deep/10"
                  >
                    {isWhatsApp ? (
