...
const suitableFor = [
  ...
  "Individu yang tidak menyediakan stok produk sendiri",
  "Pemilik toko online atau media sosial",
  "Pelaku bisnis digital yang ingin menambah lini produk",
];
...
const rules = [
  "Minimal pembelian mengikuti Business Rule yang berlaku",
    ...
    <>
      ...
      <Section className="bg-cream-2">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8">
            <Link
              href="/partner/dropshipper/register"
